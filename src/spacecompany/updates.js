Game.updates = (function () {
	...
	instance.updateTemplate = Handlebars.compile(
			...
			if (extra > 0) {
				var extraUpdates = {
					desc:
						"+" +
						extra +
						" more. Click the version number to see the full changelog.",
					read: false,
				};
...
Game.updatesData = (function () {
	...
	instance.nerfEnergyEff = {
		desc:
			"Nerfed Energy Efficiency to be 100x cheaper, but only go up to 25%",
		read: false,
	};

	instance.batteryEff = {
		desc:
			"Battery Efficiency Upgrade increases your battery storage by 1% (max 50)",
		read: false,
	};

	instance.effResearchLevel = {
		desc:
			"Changed Efficiency researches to show current level instead of next level",
		read: false,
	};
	...
	instance.redDestroy = {
		desc:
			"More -> Graphics Options. Added option to turn destroy buttons red.",
		read: false,
	};
	...
	instance.hideButton = {
		desc:
			"You can unhide completed tabs if wanted. More -> Graphics Options.",
		read: false,
	};

	instance.achivementsReset = {
		desc:
			"Achievements have been reset, you will get back any you are currently over the level needed for.",
		read: false,
	};
	...
	instance.fixSecondRebirth = {
		desc:
			"Fixed Subsequent Rebirths. You can now rebirth more than once without fear of save corruption!",
		read: false,
	};
	...
	instance.memoryLeak = {
		desc:
			"Fixed Huge Memory Leak. The Game should run much smoother now and use much less CPU",
		read: false,
	};
	...
	instance.starListExpansion = {
		desc:
			"Massively expanded the list of star systems that can be traveled to and conquered in the interstellar tab",
		read: false,
	};
	...
	instance.loadScreenInvert = {
		desc:
			"Inverted the loading screen colours to help night-time players retain their eyesight",
		read: false,
	};
